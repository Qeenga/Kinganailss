...
const articles = [
  {
    index: '01', title: 'Így marad szép a körmöd két időpont között',
  ...
  {
    index: '02', title: 'Miért fontos a háromhetes visszatérés?',
  ...
  {
    index: '03', title: 'Mit jelent a professzionális szalonhigiénia?',
  ...
  {
    index: '04', title: 'Csendes luxus, gyöngyfény és finom részletek',
  ...
  {
    index: '05', title: 'Prémium hatás rövid hosszon: soft square és mikrofrancia',
  ...
  {
    index: '06', title: 'Melyik körömforma illik a kezedhez?',
  ...
  {
    index: '07', title: 'Tejes árnyalatok és ápolt természetesség',
  ...
  {
    index: '08', title: 'Üveghatás, cat-eye és finom króm 2026-ban',
